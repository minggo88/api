...
//         }
        ...
        /**
         * 헥토데이터 빠른조회 api 서비스
         * 1. 입금 신청한 데이터가 있다면(js_exchange_wallet_txn) 
        ...
        public function hectoApiExec() {
            ...
            $currencies = $this->query_list_object($sql);
            ...
            if ($responseCode == 200) {
                    ...
                    $this->error('049', __('토큰실패'. $responseCode));
            }
            ...
            $pw = $this->encryptRSA($password1, $publicKey);
            ...
            $acpw = $this->encryptRSA($decryptedData, $publicKey);
            ...
            if ($httpCode == 200) {
                ...
                for ($i = count($apiArray) - 1; $i >= 0; $i--) {
                    ...
                    $cnt = $this->query_one($sql_income_api_search);
                    ...
                    if($cnt <1){
                        ...
                        ";
                        $this->query_one($sql_income_insert);
                    }
                }
                // data 데이터
                ...
                $this->error('049', __('API 요청 실패'. $httpCode. '  //  '. $response)); //주문수량을 잔여수량 이하로 입력해주세요.
            ...
            $update_cnt = $this->query_one($update_cnt_sql);
            ...
            for ($i = 0; $i < $update_cnt; $i++) {
                ...
                $income_cnt = $this->query_one($sql_income_search);
                ...
                if($income_cnt>0){
                    ...
                    $this->query_one($sql_wallet_update);
