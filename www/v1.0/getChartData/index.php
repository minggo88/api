...
$cache_id = 'getChartData-'.$symbol.'/'.$exchange.'/'.$goods_grade.'/'.$period.'/'.$cnt;
$c = $tradeapi->get_cache($cache_id);
if($c=='') {
    $c = $tradeapi->set_cache($cache_id, $tradeapi->get_chart_data($symbol, $exchange, $period, $goods_grade, $cnt), $sec);
}
