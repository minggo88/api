...
// validate parameters
$symbol = checkSymbol(setDefault(loadParam('symbol'), $tradeapi->default_exchange));
...
$query = "select bank_name, account_no, account_user, concat(bank_name,' / ', account_no,' / ', account_user) bank_full_info  from js_config_account  WHERE coin='{$tradeapi->escape($symbol)}' ";
